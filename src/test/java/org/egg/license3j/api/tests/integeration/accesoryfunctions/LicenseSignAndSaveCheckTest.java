...
class LicenseSignAndSaveCheckTest {
	...
	@Test
	void freshLicenseSignAndSaveCheck() throws Exception {
		...
		ls.addFeature("FeatureName", FeatureType.STRING, "Content");
		...
		ls.saveLicense("clam.bin", IOFormat.BINARY);
	...
	@Test
	void existingLicenseSaveCheck() throws Exception {
